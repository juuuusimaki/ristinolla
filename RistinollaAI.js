...
function Change(frmKohde, imgKuva) {
    if (game_status.voitto == true || game_status.i == 9) {
    ...
    if (game_status.vuoro == 2) {
        ...
        if (game_status.i < 9) {
            if (imgKuva.disabled != true) {
                ...
                if (game_status.voitto == false && game_status.i < 9) {
                    AI(frmKohde);
                }
            }
            else {
...
function Valinta() {
    ...
    if (game_status.game_matrix[n][m] == 1) {
    ...
    if (game_status.game_matrix[n][m] == 0) {
        game_status.game_matrix[n][m] = 1;
        console.log("Tyhjään");
        return;
    }
    if (game_status.game_matrix[n][m] != 0) {
        while (game_status.game_matrix[n][m] != 0) {
            n = Math.floor(Math.random() * 3); // Satunnainen kokonaisluku riveille
            m = Math.floor(Math.random() * 3); // Sama sarakkeille
        }
...
function Voitto(frmKohde) {
    ...
    if (((game_status.game_matrix[0][0] == 1) && (game_status.game_matrix[0][1] == 1)) && ((game_status.game_matrix[0][1] == 1) && (game_status.game_matrix[0][2] == 1))) {
    ...
    if (((game_status.game_matrix[1][0] == 1) && (game_status.game_matrix[1][1] == 1)) && ((game_status.game_matrix[1][1] == 1) && (game_status.game_matrix[1][2] == 1))) {
    ...
    if (((game_status.game_matrix[2][0] == 1) && (game_status.game_matrix[2][1] == 1)) && ((game_status.game_matrix[2][1] == 1) && (game_status.game_matrix[2][2] == 1))) {
        console.log("Tietokone voitti!");
        alert("Tietokone voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Tietokone voitti!";
    ...
    if (((game_status.game_matrix[0][0] == 1) && (game_status.game_matrix[1][0] == 1)) && ((game_status.game_matrix[1][0] == 1) && (game_status.game_matrix[2][0] == 1))) {
        console.log("Tietokone voitti!");
        alert("Tietokone voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Tietokone voitti!";
    ...
    if (((game_status.game_matrix[0][1] == 1) && (game_status.game_matrix[1][1] == 1)) && ((game_status.game_matrix[1][1] == 1) && (game_status.game_matrix[2][1] == 1))) {
        console.log("Tietokone voitti!");
        alert("Tietokone voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Tietokone voitti!";
    ...
    if (((game_status.game_matrix[0][2] == 1) && (game_status.game_matrix[1][2] == 1)) && ((game_status.game_matrix[1][2] == 1) && (game_status.game_matrix[2][2] == 1))) {
        console.log("Tietokone voitti!");
        alert("Tietokone voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Tietokone voitti!";
    ...
    if (((game_status.game_matrix[0][0] == 1) && (game_status.game_matrix[1][1] == 1)) && ((game_status.game_matrix[1][1] == 1) && (game_status.game_matrix[2][2] == 1))) {
        console.log("Tietokone voitti!");
        alert("Tietokone voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Tietokone voitti!";
    ...
    if (((game_status.game_matrix[0][2] == 1) && (game_status.game_matrix[1][1] == 1)) && ((game_status.game_matrix[1][1] == 1) && (game_status.game_matrix[2][0] == 1))) {
        console.log("Tietokone voitti!");
        alert("Tietokone voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Tietokone voitti!";
    ...
    if (((game_status.game_matrix[0][0] == 2) && (game_status.game_matrix[0][1] == 2)) && ((game_status.game_matrix[0][1] == 2) && (game_status.game_matrix[0][2] == 2))) {
    ...
    if (((game_status.game_matrix[1][0] == 2) && (game_status.game_matrix[1][1] == 2)) && ((game_status.game_matrix[1][1] == 2) && (game_status.game_matrix[1][2] == 2))) {
        console.log("Pelaaja voitti!");
        alert("Pelaaja voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Pelaaja voitti!";
    ...
    if (((game_status.game_matrix[2][0] == 2) && (game_status.game_matrix[2][1] == 2)) && ((game_status.game_matrix[2][1] == 2) && (game_status.game_matrix[2][2] == 2))) {
        console.log("Pelaaja voitti!");
        alert("Pelaaja voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Pelaaja voitti!";
    ...
    if (((game_status.game_matrix[0][0] == 2) && (game_status.game_matrix[1][0] == 2)) && ((game_status.game_matrix[1][0] == 2) && (game_status.game_matrix[2][0] == 2))) {
        console.log("Pelaaja voitti!");
        alert("Pelaaja voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Pelaaja voitti!";
    ...
    if (((game_status.game_matrix[0][1] == 2) && (game_status.game_matrix[1][1] == 2)) && ((game_status.game_matrix[1][1] == 2) && (game_status.game_matrix[2][1] == 2))) {
        console.log("Pelaaja voitti!");
        alert("Pelaaja voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Pelaaja voitti!";
    ...
    if (((game_status.game_matrix[0][2] == 2) && (game_status.game_matrix[1][2] == 2)) && ((game_status.game_matrix[1][2] == 2) && (game_status.game_matrix[2][2] == 2))) {
        console.log("Pelaaja voitti!");
        alert("Pelaaja voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Pelaaja voitti!";
    ...
    if (((game_status.game_matrix[0][0] == 2) && (game_status.game_matrix[1][1] == 2)) && ((game_status.game_matrix[1][1] == 2) && (game_status.game_matrix[2][2] == 2))) {
        console.log("Pelaaja voitti!");
        alert("Pelaaja voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Pelaaja voitti!";
    ...
    if (((game_status.game_matrix[0][2] == 2) && (game_status.game_matrix[1][1] == 2)) && ((game_status.game_matrix[1][1] == 2) && (game_status.game_matrix[2][0] == 2))) {
        console.log("Pelaaja voitti!");
        alert("Pelaaja voitti!");
        game_status.voitto = true;
        frmKohde.txtVuoro.value = "Pelaaja voitti!";
